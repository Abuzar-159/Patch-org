({
    doInit : function(component, event, helper){
        try{
            var qry = ' AND IsActive = true ';
            component.set("v.prodqry", qry);
    ...
    DeleteRecord : function(component, event, helper) { 
        //Moin added this 11th july 2023
                ...
                if(pol.length > 0){
                    ...
                    if(pol[length-1].Accounts != null && pol[length-1].Accounts != undefined){
                        if(pol[length-1].Accounts.length > 0){
                            if(pol[length-1].Accounts[0].ERP7__Project__c != undefined && pol[length-1].Accounts[0].ERP7__Project__c != null && pol[length-1].Accounts[0].ERP7__Project__c != ''){
                                projId = pol[length-1].Accounts[0].ERP7__Project__c;
                            }
                        }
                    }
                    console.log('projId~>'+projId);
                    if(pol[length-1].ERP7__Chart_Of_Account__c != null && pol[length-1].ERP7__Chart_Of_Account__c != undefined && pol[length-1].ERP7__Chart_Of_Account__c != ''){
                        coaId = pol[length-1].ERP7__Chart_Of_Account__c;
                    }
                    console.log('coaId~>'+coaId);
                    component.set("v.Item.ERP7__Chart_Of_Account__c", coaId);
                    if(pol[length-1].ERP7__Account_Category__c != null && pol[length-1].ERP7__Account_Category__c != undefined && pol[length-1].ERP7__Account_Category__c != ''){
                        component.set("v.Item.ERP7__Account_Category__c", pol[length-1].ERP7__Account_Category__c);
                    }
                }
                
                if(remainingTotalAAPercent > 0){
                    polList.push({sObjectType :'ERP7__Dimension__c', ERP7__Chart_of_Account__c : coaId, ERP7__Project__c : projId, ERP7__Sort_Order__c:parseInt(component.get("v.Item.ERP7__Sort_Order__c")), ERP7__Allocation_Percentage__c :remainingTotalAAPercent, ERP7__Allocation_Amount__c: (parseFloat(parseFloat(component.get("v.Item.ERP7__Quantity__c")) * parseFloat(component.get("v.Item.ERP7__Amount__c"))) * remainingTotalAAPercent)/100 });
                }else console.log('arshad new dimension not added because remainingTotalAAPercent~>'+remainingTotalAAPercent);         
            }else{
                if(remainingTotalAAPercent > 0){
                    polList.push({sObjectType :'ERP7__Dimension__c', ERP7__Chart_of_Account__c : null, ERP7__Project__c : null, ERP7__Sort_Order__c:parseInt(component.get("v.Item.ERP7__Sort_Order__c")), ERP7__Allocation_Percentage__c :remainingTotalAAPercent, ERP7__Allocation_Amount__c: (parseFloat(parseFloat(component.get("v.Item.ERP7__Quantity__c")) * parseFloat(component.get("v.Item.ERP7__Amount__c"))) * remainingTotalAAPercent)/100 });
                }else console.log('arshad new dimension not added because remainingTotalAAPercent~>'+remainingTotalAAPercent);    
            }
