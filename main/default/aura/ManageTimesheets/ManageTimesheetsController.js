({
    getTimeSheetApproval: function(component, event, helper) {
        helper.getTimeSheetApproval(component, event, helper);
    },
    
    sortByName: function(component, event, helper) {
        helper.sortBy(component, "ERP7__Employees__r.ERP7__Last_Name__c");
    },
    ...
    Approve: function(component, event, helper) {
        ...
        var action = component.get("c.arTimesheet");
        action.setParams({
        ...
        action.setCallback(this, function(response) {
            ...
            if (component.isValid() && state === "SUCCESS") {
                var submittedTs = component.get("v.TimeSheets");
                helper.getTimeSheetApproval(component, event, helper);
                var btn = event.source;
                var cmp = component.find(btn.get("v.buttonTitle"));
                $A.util.removeClass(cmp.getElement(), 'slds-show');
