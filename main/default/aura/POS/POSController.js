({
    ...
    saveEstimateToOrder: function(cmp, event) {
        $A.util.removeClass(cmp.find('upsLoader'), "slds-hide");
        ...
        if(SalesOrder[0].Id != undefined){
            ...
            $A.util.addClass(cmp.find('upsLoader'), "slds-hide");
        }
        ...
        if(SalesOrder[0].Id != undefined){
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") { 
                    ...
                    //alert(response.getReturnValue().PackageTypes);
                    $A.util.addClass(cmp.find('upsLoader'), "slds-hide");
                    if(packType == null) cmp.find("packType").set("v.options", response.getReturnValue().PackageTypes);
    ...
    FedExServices: function(cmp, event) {
        $A.util.removeClass(cmp.find('FedExLoader'), "slds-hide");
        var SalesOrder = new Array(cmp.get("v.SalesOrder"));
        ...
        if(SalesOrder[0].Id != undefined){
            ...
            $A.util.addClass(cmp.find('FedExLoader'), "slds-hide");
        }
        if(SalesOrder[0].Id != undefined){
            //alert('IN');
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") { 
                    ...
                    //alert(response.getReturnValue().PackageType);
    ...
    DHL_Services: function(cmp, event) {
        ...
        $A.util.removeClass(cmp.find('DHLLoader'), "slds-hide");
        var SalesOrder = new Array(cmp.get("v.SalesOrder"));
        //alert('DHL Service In '+SalesOrder[0].Id);
        if(SalesOrder[0].Id != undefined){
            cmp.set("v.DHLError", '');
        } else{
            cmp.set("v.DHLError", 'Please save the sales order');
            $A.util.addClass(cmp.find('DHLLoader'), "slds-hide");
        }
        if(SalesOrder[0].Id != undefined){
            //alert('IN');
            ...
            if(rateWrapper != ''){
                ...
                action.setCallback(this, function(response) {
                    ...
                    if (state === "SUCCESS") {
                        ...
                        $A.util.addClass(cmp.find('DHLModal'),'hide');
                        cmp.set("v.SON",RecId);
                        cmp.set("v.CON","");
                        cmp.set("v.CUST","");   
                        cmp.popInit();
    ...
    CashPayment: function(cmp, event) {
        $A.util.removeClass(cmp.find('cashSpin'), "slds-hide");
        ...
        if(SalesOrder[0].Id != undefined && Customer.length > 0 && SalesOrder.length > 0 && Payment.length > 0 && FinalDue > 0 && Payment[0].ERP7__Amount__c > 0 && Payment[0].ERP7__Amount__c <= FinalDue){
            Proceed = true;
            cmp.set("v.CashError", '');
        } else{
            cmp.set("v.CashError", 'Invalid Details');
            $A.util.addClass(cmp.find('cashSpin'), "slds-hide");
        }
    ...
    BankPayment: function(cmp, event) {
        $A.util.removeClass(cmp.find('bankPayments'), "slds-hide");
        var Customer = new Array(cmp.get("v.Customer"));
        var custsize = Customer.length;
        var SalesOrder = new Array(cmp.get("v.SalesOrder"));
        var sosize = SalesOrder.length;
        ...
        var Proceed = false;
        var RecId = SalesOrder[0].Id;
        if(Payment[0].ERP7__Bank__c != undefined && Payment[0].ERP7__Reference_Cheque_No__c != undefined && Payment[0].ERP7__Account_Number__c != undefined && SalesOrder[0].Id != undefined && Customer.length > 0 && SalesOrder.length > 0 && Payment.length > 0 && FinalDue > 0 && Payment[0].ERP7__Amount__c > 0 && Payment[0].ERP7__Amount__c <= FinalDue){
            Proceed = true;
            cmp.set("v.BankError", '');
        } else{
            cmp.set("v.BankError", 'Invalid Details');
            $A.util.addClass(cmp.find('bankPayments'), "slds-hide");
        }
        //alert('Proceed : '+Proceed);
    ...
    CardPayment: function(cmp, event) {
        $A.util.removeClass(cmp.find('cardPayment'), "slds-hide");
        var Customer = new Array(cmp.get("v.Customer"));
        var custsize = Customer.length;
        var SalesOrder = new Array(cmp.get("v.SalesOrder"));
        var sosize = SalesOrder.length;
    ...
    Navigat : function(cmp, event) {
        //$A.util.removeClass(cmp.find('blueRecent'), "slds-hide");
    ...
    ProcessLoyalty : function(cmp, event) {
        ...
        if(Customer.length > 0 && SalesOrder.length > 0 && customerCreditLimit > 0 && FinalDue > 0 && LoyaltyPoint2Use > 0 && LoyaltyPoint2Use <= customerCreditLimit){
            $A.util.removeClass(cmp.find('loyaltyPayments'), "slds-hide");
            $A.util.removeClass(cmp.find('mainSpin'), "slds-hide");
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {
                    ...
                    cmp.saveMethod();
                    $('#myModalLoyalty').modal('hide');
                }   else {
                    cmp.set("v.LoyaltyError", response.getReturnValue()); 
                    $A.util.addClass(cmp.find('loyaltyPayments'), "slds-hide");
                }
            });
            $A.enqueueAction(action);
        } else {
    ...
    ProcessCredit : function(cmp, event) {
        ...
        if(Customer.length > 0 && SalesOrder.length > 0 && Invoice.length > 0 && CreditAmount > 0 && FinalDue > 0 && CreditAmount2Use > 0 && CreditAmount2Use <= CreditAmount && CreditAmount2Use <= FinalDue){
            $A.util.removeClass(cmp.find('creditPayments'), "slds-hide");
            //$A.util.removeClass(cmp.find('mainSpin'), "slds-hide");
            ...
            action.setCallback(this, function(response) {
                ...
                $A.util.addClass(cmp.find('creditPayments'), "slds-hide");                
            });
        	$A.enqueueAction(action);
        } else {
    ...
    RMA : function(cmp, event) {
        ...
        if(Contact.length > 0 && SalesOrder.length > 0){
            if(SalesOrder[0].ERP7__Is_Closed__c == true){
                ...
                var URL_RMA = '/apex/ERP7__RMA?Id='+SalesOrder[0].Id;
    ...
    CreateCon : function(cmp, event) {
        ...
        if(NewCust.Id == undefined || Conts[0].AccountId == undefined || Conts[0].FirstName == undefined || Conts[0].LastName == undefined){
    ...
    CreateAddress : function(cmp, event) {
        ...
        var County = cmp.get("v.County");
        var Country = cmp.get("v.Country");
        if(NewAddres[0].ERP7__Customer__c != undefined && NewAddres[0].ERP7__Contact__c != undefined && NewAddres[0].ERP7__Address_Line1__c != undefined && NewAddres[0].ERP7__City__c != undefined  && Country != undefined  && NewAddres[0].ERP7__Postal_Code__c != undefined){
            var action = cmp.get("c.SaveNewAddress");
            action.setParams({ 
                NewAddres1: NewAddres,
                County: County,
                Country: Country
            });
    ...
    lookupChangeAccountNumber : function(cmp) {
    ...
    getAllDetails : function(cmp, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                //var iik = response.getReturnValue().Order.ERP7__Employees__c;
                //alert(iik);
                ...
                //cmp.set("v.NewContact", response.getReturnValue().NewCont);
                //cmp.set("v.NewAddress", response.getReturnValue().NewAddresses);
                ...
                if(response.getReturnValue().invoice.Name == null) { cmp.set("v.invoiceName", ''); } 
                ...
                cmp.set("v.Payment.ERP7__Amount__c", '');
                ...
                cmp.set("v.pdLists",[]);
                    ...
                    //$A.util.addClass(cmp.find('blueRecent'), "slds-hide");
                    $A.util.addClass(cmp.find('mainSpin'), "slds-hide");
                    $A.util.addClass(cmp.find('cashSpin'), "slds-hide");
                    $A.util.addClass(cmp.find('bankPayments'), "slds-hide");
                    $A.util.addClass(cmp.find('couponSpins'), "slds-hide");
                    $A.util.addClass(cmp.find('cardPayment'), "slds-hide");
                    $A.util.addClass(cmp.find('loyaltyPayments'), "slds-hide");
                    $A.util.addClass(cmp.find('creditPayments'), "slds-hide");
                    $A.util.addClass(cmp.find('addSpin'), "slds-hide");
                    $A.util.addClass(cmp.find('ShipmentLoader'), "slds-hide");
                } catch(err) {
                    $A.util.addClass(cmp.find('mainSpin'), "slds-hide");
                    $A.util.addClass(cmp.find('cashSpin'), "slds-hide");
                    $A.util.addClass(cmp.find('bankPayments'), "slds-hide");
    ...
    ApplyCoupon : function(cmp) {
        ...
        if(SO.Id != undefined && Coupon != undefined && Coupon != ''){
            $A.util.removeClass(cmp.find('couponSpins'), "slds-hide");
    ...
    fetchProduct : function(cmp, event, helper) {
        try{
            $A.util.removeClass(cmp.find('addSpin'), "slds-hide");
    ...
    getBatchesEdit : function(cmp, event) {
        try{
            var currentSalepoints = new Array(cmp.get("v.currentSalepoint"));
            var Customers = new Array(cmp.get("v.Customer"));
            $A.util.removeClass(cmp.find('editSpin'), "slds-hide");
            var BatchNumber = cmp.get("v.BatchNumber");
            if(BatchNumber == undefined) BatchNumber = "";
            ...
            action.setCallback(this, function(response) {
                ...
                $A.util.addClass(cmp.find('editSpin'), "slds-hide");
            });
            $A.enqueueAction(action);
        } catch(err) {
            alert("Exception : "+err.message);
    ...
    getFromSerials : function(cmp, event) {
        $A.util.removeClass(cmp.find('blueSpin'), "slds-hide");
                ...
                if (state === "SUCCESS") {
                    ...
                    actions.setCallback(this, function(response) {
                        ...
                        if (state === "SUCCESS") {
                            ...
                            cmp.set("v.ProductsAndDiscountsWrapperListt", obj);
                            $A.util.addClass(cmp.find('blueSpin'), "slds-hide");
                        }
                    });
                ...
                if (state === "SUCCESS") {
                    ...
                    if(obj[count].product.ERP7__Serialise__c){
                       var actions = cmp.get("c.getSerialNos");
                        actions.setParams({
                        	currentSalepoints1 : currentSalepoints,
                            Customers1 : Customers,
    ...
    draftSave : function (cmp, event) {
        ...
        if(currentEmployee.Id == undefined){
            ...
            if(coms.length > 0 || SO.Name != undefined){
                $A.util.removeClass(cmp.find('blueSpins'), "slds-hide");
                ...
                action.setCallback(this, function(response) {
                    ...
                    $A.util.addClass(cmp.find('blueSpins'), "slds-hide");
                });
                $A.enqueueAction(action);
            }
        }  
    ...
    draftSaveShipment : function (cmp, event) {
        ...
        if(coms.length > 0 || SO.Name != undefined){
            $A.util.removeClass(cmp.find('ShipmentLoader'), "slds-hide");
            var action = cmp.get("c.saveDrafts");
            action.setParams({
                selWrap: JSON.stringify(coms),
                currentSalepoints1 : JSON.stringify(currentSalepoints),
    ...
    CreateWO : function(cmp, event, helper) {
        ...
        var SalesOrder = new Array(cmp.get("v.SalesOrder"));
        var URL_RMA = '/apex/ERP7__WorkOrderLC?soliId='+SOLI+'&so='+SalesOrder[0].Id;
        window.open(URL_RMA,'_blank');
    },
    ...
    CreateMO : function(cmp, event, helper) { 
        ...
        var SalesOrder = new Array(cmp.get("v.SalesOrder"));
        var URL_RMA = '/apex/ERP7__ManufacturingOrderLC?mosoliId='+SOLI;
        window.open(URL_RMA,'_blank');
    }
})