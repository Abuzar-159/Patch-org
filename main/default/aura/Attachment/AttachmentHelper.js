({
    ...
    uploadProcess: function(component, file, fileContents) {
        ...
        /*FOR PLM APPLICATION*/
        if(component.get("v.Application")=='PLM'){ //this.doSave(component, event);
                var getchunk = fileContents.substring(startPosition, endPosition);
                                                  
                var e=$A.get("e.c:AttachmentEvnet"); //component.getEvent("Attachment");                                                 
                                                            
                e.setParams({
                    "Body":encodeURIComponent(getchunk),
                    "FileName":file.name,
    ...
    uploadInChunk: function(component, file, fileContents, startPosition, endPosition, attachId) {
        ...
        action.setParams({
            parentId: ParentId, //component.get("v.parentId"),
            fileName: file.name,
     ...
     /* action.setParams({
      ...
      if (comp.isValid() && state === "SUCCESS") {  
          ...
          for(var i in res){
            ...
            comp.find("fileId").set("v.body",i); //body  files  
         ...
         // comp.set("v.AttachmentBody",response.getReturnValue());                                        
          ...
          //('fetchAttachmentRecord Exception Occured');          
     });
     $A.enqueueAction(action);        
    },
