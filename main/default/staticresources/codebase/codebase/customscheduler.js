...
gantt = {
    ...
    }), gantt._eventable(gantt), gantt._click = {}, gantt._dbl_click = {}, gantt._context_menu = {},

    gantt._on_click = function(t) {
        //var iktsk = gantt.getTask(n);
        //alert(iktsk.id);
        t = t || window.event;
    ...
    gantt._on_contextmenu = function(t) {
        ...
        dragStart: function(t, e) {
            //var k = this.getLightboxValues();
            //var ee = this.getTask(k.id);
            //e.duration += 1;
            //e.end_date.setDate(e.start_date.getDate() + e.duration);
            //alert(e.id);
            //var kkk = JSON.stringify(this.getPosition(e));
            //alert('dragstart : '+n);
            this.config = {
                obj: t,
                marker: null,
            ...
            var n = gantt.bind(function(e) {
                ...
                i = gantt.bind(function(e) {
                    return gantt.eventRemove(document.body, "mousemove", a), gantt.eventRemove(document.body, "mouseup", i), this.dragEnd(t,e)
                }, this);
        ...
        dragMove: function(t, e) {
            ...
            this.config.ignore || (e.pos = this.getPosition(e), this.config.marker.style.left = e.pos.x + "px", this.config.marker.style.top = e.pos.y + "px", this.callEvent("onDragMove", [t, e]));
             //var ee = gantt.locate(e);
             //var lll = this.getTask(ee);
             //alert(ee);
             //alert(lll.duration);
             //var ikval = JSON.stringify(lll);
             //updateSchedule(ikval);
             //alert('drag move : ');
             //var ee = gantt.locate(e);
             //alert('ee : '+ee);
        ...
        dragEnd: function(t, e) {
           //var lll = this.getTask(t.config.id);
            //alert('dragend'+e);
                 ...
                 if(ee != null){
                     ...
                     var lll = gantt.getTask(ee);

                     //alert('duration : '+lll.duration);
                     //alert('progress : '+lll.progress);

                     var ssd = lll.start_date;
                     var eed = lll.end_date;
                     lll.start_date_temp = String(ssd.getFullYear()) +':'+ String(ssd.getMonth()+1) +':'+ String(ssd.getDate()) +':'+ String(ssd.getHours()) +':'+ String(ssd.getMinutes()) +':'+ String(ssd.getSeconds());
                     lll.end_date_temp = String(eed.getFullYear()) +':'+ String(eed.getMonth()+1) +':'+ String(eed.getDate()) +':'+ String(eed.getHours()) +':'+ String(eed.getMinutes()) +':'+ String(eed.getSeconds());
                ...
                //e.end_date.setDate(e.start_date.getDate() + e.duration);
                //alert(ee.id);
            //var xmlik = new XMLSerializer().serializeToString(t);
        ...
        for (var t = this.getGridColumns(), e = [], n = 0, a = this.locale.labels, i = this.config.scale_height - 2, s = 0; s < t.length; s++) {
            ...
            //var ik = "<div class='" + l + "' style='width:10px;color:green; ' column_id='" + o.name + "'>IK</div>";
            e.push(c);
            //e.push(ik)
        }
        ...
        for (var e = this.getGridColumns(), n = [], a = 0; a < e.length; a++) {
            var i, s, r = a == e.length - 1,
                o = e[a];
                //alert(t.parent);
                var hideplus = (t.parent != '0')? "hidden" : "visible";
            "add" == o.name ? s = "<div class='gantt_add' style='visibility:" + hideplus + ";'></div>" : (s = o.template ? o.template(t) : t[o.name],
                s instanceof Date && (s = this.templates.date_grid(s, t)), s = "<div class='gantt_tree_content'>" + s + "</div>");
            var _ = "gantt_cell" + (r ? " gantt_last_cell" : ""),
                d = "";
            if (o.tree) {
                for (var l = 0; l < t.$level; l++) d += this.templates.grid_indent(t);
    ...
    alert('moveTask');
        ...
        this.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity),
            ...
            t.attachEvent("onDragEnd", this.bind(function() {
                alert('ondragend');
        ...
        _resize_progress: function(t, e, n) {
            ...
            t.progress = parseFloat(Math.min(1, i / (a.end - a.start))*100).toFixed(2);
            //alert(t.progress);
        },
        ...
        l.attachEvent("onDragEnd", gantt.bind(function() {
            alert('onDragEnd bind');
            var t = a();
        ...
        gantt._is_link_drop_area = function(t) {
        ...
        var t = this._tasks;
        t.bar_height = this._get_task_height(), this.$task_data.style.height = Math.max(this.$task.offsetHeight - this.config.scale_height, 0) + "px", gantt.config.smart_rendering ? this.$task_bg.style.height = gantt.config.row_height * this.getVisibleTaskCount() + "px" : this.$task_bg.style.height = "", this.$task_bg.style.backgroundImage = "";
        ...
        if (!this._isAllowedUnscheduledTask(t)) {
            ...
            //alert('class : '+t.scheduleType);
            if(t.scheduleType == "Production Schedule") { var d = this._combine_item_class("gantt_task_line", this.templates.task_class1(t.start_date, t.end_date, t), t.id); }
            else { var d = this._combine_item_class("gantt_task_line", this.templates.task_class2(t.start_date, t.end_date, t), t.id); }
        ...
        var n = document.createElement("div");
        //alert('hi');
        return this._get_safe_type(t.type) != this.config.types.milestone && (n.innerHTML = this.templates.task_scheduleName(t.start_date, t.end_date, t)),
            n.className = "gantt_task_content", n
    }, gantt._render_task_progress = function(t, e, n) {
        var a = 1 * t.progress * 0.01 || 0;
        n = Math.max(n - 2, 0);
        var i = document.createElement("div"),
            s = Math.round(n * a);
    ...
    gantt.createTask = function(t, e, n) {
        ...
        if (t = t || {}, t.id = gantt.uid(), t.start_date || (t.start_date = gantt._default_task_date(t, e)), void 0 === t.text && (t.text = gantt.locale.labels.new_task), void 0 === t.duration && (t.duration = 1), e) {
            ...
            var a = this.getTask(e);
             if (a) {
                 //var workorderr = document.getElementById("workorderName").value;
                 //var workorderrId = document.getElementById("workorderId").value;
                 //document.getElementById("workorderName").value = a.WorkOrder;
                 //document.getElementById("workorderId").value = a.woId;
                 //n = this.getParent(a),
                 //t.scheduleName = a.scheduleName;
                 // assign fields
                 //alert(a.WorkOrder);
             }
            a.$open = !0
    ...
    gantt.calculateEndDate = function(t, e, n) {
        var a = this._working_time_helper,
            i = e >= 0 ? 1 : -1;
            var edtik = a.add_worktime(t, Math.abs(e), n || this.config.duration_unit, i * this.config.duration_step);
            if(e == '7' || e == '2'){
               /* alert('t: '+t);
                alert('e: '+e);
                alert('n: '+n);
                alert('this.config.duration_unit: '+this.config.duration_unit);
                alert('i: '+i);
                alert('this.config.duration_step: '+this.config.duration_step);
                alert('edtik: '+edtik); */
            }
        return edtik
    },
    ...
    gantt._lightbox_template = "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><span class='gantt_title'></span><span class='gantt_title'></span><span style='color:red;padding-left:50px;' id='eremsg'>All fields with * marked are mandatory</span></div><div class='gantt_cal_larea'></div>",

    gantt.showLightbox = function(t) {
        if (t && !gantt._is_readonly(this.getTask(t)) && this.callEvent("onBeforeLightbox", [t])) {
            var e = this.getTask(t);
            //alert('duration : '+e.duration);
            //var sss = JSON.stringify(e);
            //alert('new Task : '+e.$new);
            //if(e.parent != '0'){
                //var parnt = this.getParent(e.id);
                //var parntask = this.getTask(parnt);
                 //var workorderr = document.getElementById("workorderName").value;
                 ...
                 //n = this.getParent(a),
                 //t.scheduleName = a.scheduleName;
                 //alert('parent : '+e.parent);
            //}
            //e.duration -= 1;
            //alert('New Dur : '+e.duration);
            //e.end_date.setDate(e.start_date.getDate() + e.duration);
            //e.end_date.setTime( e.start_date.getTime() + e.duration * 86400000 );
            //alert('start_date : '+e.start_date);
            //alert('end_date : '+e.end_date);
            if(e.$new == true && e.parent != '0'){
                //alert('assign values from parent to t values');
                //assign values from parent to t values

                var parnt = this.getParent(e.id);
                var parntask = this.getTask(parnt);

                e.Processes = parntask.Processes;
                e.workStation = parntask.workStation;
                e.lineitem = parntask.lineitem;
                e.WorkOrder = parntask.WorkOrder;
                e.productservice = parntask.productservice;
                e.schedule = parntask.scheduleName;
                e.isNew = true;
                //e.cycle
            }

            var n = this.getLightbox(this._get_safe_type(e.type));
            this._center_lightbox(n), this.showCover(), this._fill_lightbox(t, n), this.callEvent("onLightbox", [t]);


            if(e.$new == true && e.parent != '0'){
                //alert('assign documentIds from parent to lightbox');
                //assign documentIds from parent to lightbox
                ...
                document.getElementById("workstationId").value = parntask.wsId;
                //document.getElementById("cycleId").value = parntask.cycleId;

            } else if(e.$new == true && e.parent == '0'){
            ...
            if(e.$new != true){
                //alert('assign documentIds from t to lightbox');
                //assign documentIds from t to lightbox

                document.getElementById("schId").value = e.parent;
                document.getElementById("workorderId").value = e.woId;
                document.getElementById("processId").value = e.processId;
                document.getElementById("lineitemId").value = e.lineId;
                document.getElementById("productId").value = e.productId;
                document.getElementById("workstationId").value = e.wsId;
                document.getElementById("cycleId").value = e.cycleId;
            }

            /*
            var workorderrId = document.getElementById("workorderId").value;
            var workorderr = document.getElementById("workorderName").value;
            alert('showlightbox : WO '+workorderr+' : '+workorderrId);
            */
            document.getElementById("eremsg").style.display = "none";
        }
    ...
    gantt.getLightbox = function(t) {
        //var zzz = gantt._lightbox_id;
        //var ee = gantt.locate(t);
        //alert('get lightbox values : ');
        if (void 0 === t && (t = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
            ...
            //alert('delete Button : '+i+' New : '+t.id);
            for (var s = 0; s < i.length; s++) {
                var r = this.config._migrate_buttons[i[s]] ? this.config._migrate_buttons[i[s]] : i[s];
     ...
     gantt._render_sections = function(t) {
        //var sss = JSON.stringify(t);
        //alert(t.scheduleName);

        //var zzz = this.getLightboxValues();
        //var ee = gantt.locate(t);
        //alert(zzz);



        var e = "<div class='' style='width:100%;'><table width='100%'>";
        for (var n = 0; n < t.length; n++) {
            ...
            if (a) {
                ...
                var s = "";
                if(n%2 == 0) e += "<tr>";
                if(n == t.length-1) e += "<td width='50%' colspan='2' style='padding:10px;'>";
                else e += "<td width='50%'  style='padding:10px;'>";
                var astspan = "";
                //alert(t[n].name);
                //if(t[n].name == "scheduleName" || t[n].name == "WorkOrder" || t[n].name == "processes" || t[n].name == "productservice" || t[n].name == "lineitem") astspan = "<span style='color:red;padding-top:2px;font-size: 15px;'> *</span>";
                if(t[n].name == "scheduleName") astspan = "<span style='color:red;padding-top:2px;font-size: 15px;'> *</span>";

                e += "<div id='" + t[n].id + "' class='gantt_cal_lsection'>" + s + this.locale.labels["section_" + t[n].name]  + astspan + "</div>";
                e += a.render.call(this, t[n]);
        ...
        while(n < t.length){
            ...
            if (a) {
                        ...
                        e += "<table width='100%'><tr>";
                            ...
                            e += "<td width='50%' style='padding:10px;'>";
                            e += "<div id='" + t[n].id + "' class='gantt_cal_lsection'>" + s + this.locale.labels["section_" + t[n].name] + "</div>";
                            e += a.render.call(this, t[n]);
                            //var e = a.render.call(this, t[n]);
                            e += "</td>";

                        if(n < t.length-1){
                            e += "<td width='50%' style='padding:10px;'>";
                            e += "<div id='" + t[n+1].id + "' class='gantt_cal_lsection'>" + s + this.locale.labels["section_" + t[n+1].name] + "</div>";
                            e += a.render.call(this, t[n+1]);
                            e += "</td>";
                        }
        ...
        gantt.lightbox_events.gantt_save_btn = function(t) {
    ...
    gantt._save_lightbox = function() {
        ...
        //alert(ikval);
        //if(t.scheduleName == '' || t.lineitem == '' || t.Processes == '' || t.WorkOrder == '' || t.productservice == '' ){
        if(t.scheduleName == ''){
            document.getElementById("eremsg").style.display = "";
        }else{

            if(document.getElementById("processId").value != '' && document.getElementById("processId").value != null && t.parent == '0') { t.text = document.getElementById("processName").value;}
            else if(document.getElementById("cycleId").value != '' && document.getElementById("cycleId").value != null && t.parent != '0') t.text = document.getElementById("cycleName").value;
            else if(t.parent != '0') t.text = t.scheduleName;
            ...
            var e = this.getTask(t.id);
            t.parent = document.getElementById("schId").value;
            t.woId = document.getElementById("workorderId").value;
            t.processId = document.getElementById("processId").value;
            t.lineId = document.getElementById("lineitemId").value;
            t.productId = document.getElementById("productId").value;
            t.wsId = document.getElementById("workstationId").value;
            t.cycleId = document.getElementById("cycleId").value;
            //t.start_date_temp = String(e.start_date);;
            //t.end_date_temp = String(e.end_date);

             var ssd = e.start_date;
             var eed = e.end_date;
             t.start_date_temp = String(ssd.getFullYear()) +':'+ String(ssd.getMonth()+1) +':'+ String(ssd.getDate()) +':'+ String(ssd.getHours()) +':'+ String(ssd.getMinutes()) +':'+ String(ssd.getSeconds());
             t.end_date_temp = String(eed.getFullYear()) +':'+ String(eed.getMonth()+1) +':'+ String(eed.getDate()) +':'+ String(eed.getHours()) +':'+ String(eed.getMinutes()) +':'+ String(eed.getSeconds());



            var ikval = JSON.stringify(t);
            //alert(ikval);
            saveSchedule(ikval);
    ...
    gantt._resolve_default_mapping = function(t) {
        ...
        for (var e = this._get_typed_lightbox_config(), n = 0; n < e.length; n++) {
            ...
            if (i) {
                ...
                var r = gantt._resolve_default_mapping(e[n]);
        ...
        number: {
            render: function(t) {
                ...
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input type='number' min='1' max='100' step='1'/></div>";
            },
        ...
        schedule: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                var ikwsn7 = "schName", ikwsid7 = "schId";
                //khan
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input id='schName' name='schName' type='text' disabled/><input id='schId' name='schId' type='hidden'/><img src='/s.gif' onclick='ScheduleLookUp();' alt='lookup' width='25' height='25' class='lookupIcon' /></div>";
                //return "<div class='gantt_cal_ltext' style='height:" + e + ";'>";
            },
            set_value: function(t, e, n) {
                t.firstChild.value = e || ""
            },
        ...
        cycle: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                //khan
                var ikwsn6 = "cycleName", ikwsid6 = "cycleId";
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input id='cycleName' name='cycleName' type='text' disabled/><input id='cycleId' name='cycleId' type='hidden'/><img src='/s.gif' onclick='cycleLookUp();' alt='lookup' width='25' height='25' class='lookupIcon' /><img src='{!URLFOR($Resource.codebase,'codebase/Images/deleteicon.png')}' width='25' height='25' class='delicon' onclick='dissolveWS(" + ikwsn6 + ", " + ikwsid6 + ");'/></div>";
                //return "<div class='gantt_cal_ltext' style='height:" + e + ";'>";
            },
            set_value: function(t, e, n) {
                t.firstChild.value = e || ""
        ...
        process: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                //khan
                var ikwsn5 = "processName", ikwsid5 = "processId";
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input id='processName' name='processName' type='text' disabled/><input id='processId' name='processId' type='hidden'/><img src='/s.gif' onclick='processLookUp();' alt='lookup' width='25' height='25' class='lookupIcon' /><img src='{!URLFOR($Resource.codebase,'codebase/Images/deleteicon.png')}' width='25' height='25' class='delicon' onclick='dissolveWS(" + ikwsn5 + ", " + ikwsid5 + ");'/></div>";
                //return "<div class='gantt_cal_ltext' style='height:" + e + ";'>";
            },
            set_value: function(t, e, n) {
                t.firstChild.value = e || ""
        ...
        workstation: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                var ikwsn4 = "workstationName", ikwsid4 = "workstationId";
                //khan
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input id='workstationName' name='workstationName' type='text' disabled/><input id='workstationId' name='workstationId' type='hidden'/><img src='/s.gif' onclick='workstationLookUp();' alt='lookup' width='25' height='25' class='lookupIcon' /><img src='{!URLFOR($Resource.codebase,'codebase/Images/deleteicon.png')}' width='25' height='25' class='delicon' onclick='dissolveWS(" + ikwsn4 + ", " + ikwsid4 + ");'/></div>";
                //return "<div class='gantt_cal_ltext' style='height:" + e + ";'>";
            },
            set_value: function(t, e, n) {
                t.firstChild.value = e || ""
        ...
        workorder: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                var ikwsn3 = "workorderName", ikwsid3 = "workorderId";
                //khan
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input id='workorderName' name='workorderName' type='text' disabled/><input id='workorderId' name='workorderId' type='hidden'/><img src='/s.gif' onclick='workorderLookUp();' alt='lookup' width='25' height='25' class='lookupIcon' /><img src='{!URLFOR($Resource.codebase,'codebase/Images/deleteicon.png')}' width='25' height='25' class='delicon' onclick='dissolveWS(" + ikwsn3 + ", " + ikwsid3 + ");'/></div>";
                //return "<div class='gantt_cal_ltext' style='height:" + e + ";'>";
            },
            set_value: function(t, e, n) {
                t.firstChild.value = e || ""
        ...
        lineitem: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                //khan
                var ikwsn2 = "lineitemName", ikwsid2 = "lineitemId";
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input id='lineitemName' name='lineitemName' type='text' disabled/><input id='lineitemId' name='lineitemId' type='hidden'/><img src='/s.gif' onclick='lineitemLookUp();' alt='lookup' width='25' height='25' class='lookupIcon' /><img src='{!URLFOR($Resource.codebase,'codebase/Images/deleteicon.png')}' width='25' height='25' class='delicon' onclick='dissolveWS(" + ikwsn2 + ", " + ikwsid2 + ");'/></div>";
                //return "<div class='gantt_cal_ltext' style='height:" + e + ";'>";
            },
            set_value: function(t, e, n) {
                t.firstChild.value = e || ""
        ...
        product: {
            render: function(t) {
                var e = (t.height || "130") + "px";
                var ikwsn1 = "productName", ikwsid1 = "productId";
                //khan
                return "<div class='gantt_cal_ltext' style='height:" + e + ";'><input id='productName' name='productName' type='text' disabled/><input id='productId' name='productId' type='hidden'/><img src='/s.gif' onclick='productLookUp();' alt='lookup' width='25' height='25' class='lookupIcon' /><img src='{!URLFOR($Resource.codebase,'codebase/Images/deleteicon.png')}' width='25' height='25' class='delicon' onclick='dissolveWS(" + ikwsn1 + ", " + ikwsid1 + ");'/></div>";
                //return "<div class='gantt_cal_ltext' style='height:" + e + ";'>";
            },
            set_value: function(t, e, n) {
                t.firstChild.value = e || ""
        ...
        select: {
            render: function(t) {
                for (var e = (t.height || "23") + "px", n = "<div class='gantt_cal_ltext' style='height:" + e + ";'><select style='width:90%;'>", a = 0; a < t.options.length; a++) n += "<option value='" + t.options[a].key + "'>" + t.options[a].label + "</option>";
                return n += "</select></div>"
            },
            set_value: function(t, e, n, a) {
                var i = t.firstChild;
        ...
        this.callEvent("onBeforeGanttReady", []), e && n && (this.config.start_date = this._min_date = new Date(e),
            this.config.end_date = this._max_date = new Date(n)), this._init_skin(), this.date.init(), this.config.scroll_size || (this.config.scroll_size = this._detectScrollSize()), gantt.event(window, "resize", this._on_resize), this.init = function(t) {
        ...
        this._init_html_area(t), this._set_sizes(), this._clear_renderers(), this.resetLightbox(), this._update_flags(),
        ...
        "string" == typeof t ? this._obj = document.getElementById(t) : this._obj = t, this.assert(this._obj, "Invalid html container: " + t);
        ...
        this.$grid = n[0], this.$task = n[1], this.$scroll_ver = n[2], this.$scroll_hor = n[3], this.$grid.innerHTML = "<div class='gantt_grid_scale'></div><div class='gantt_grid_data'></div>", this.$grid_scale = this.$grid.childNodes[0],
            this.$grid_data = this.$grid.childNodes[1], this.$task.innerHTML = "<div class='gantt_task_scale'></div><div class='gantt_data_area'><div class='gantt_task_bg'></div><div class='gantt_links_area'></div><div class='gantt_bars_area'></div></div>", this.$task_scale = this.$task.childNodes[0], this.$task_data = this.$task.childNodes[1], this.$task_bg = this.$task_data.childNodes[0], this.$task_links = this.$task_data.childNodes[1], this.$task_bars = this.$task_data.childNodes[2]
    }, gantt.$click = {
        buttons: {
            edit: function(t) {
    ...
    function() {
        gantt.mixin(gantt.config, {
            ...
            gantt._init_template("date_scale", !0), gantt._init_template("date_grid", !0, "grid_date_format"), gantt._init_template("task_date", !0), gantt.mixin(this.templates, {
                ...
                task_Processes: function(t, e, n) {
                    return n.Processes
                },
                task_scheduleName: function(t, e, n) {
                    return n.scheduleName
                },
                task_class: function(t, e, n) {
                    return ""
                },
                task_class1: function(t, e, n) {
                    return "ikclass1"
                },
                task_class2: function(t, e, n) {
                    return "ikclass2"
                },
        ...
        labels: {
            ...
            icon_delete: "Delete",
            confirm_closing: "",
            confirm_deleting: "Schedule will be deleted permanently, are you sure?",
        ...
        _second_column_width: 90,
        _third_column_width: 80,
        _lightbox_template: "<div class='gantt_cal_ltitle'><span class='gantt_mark'>&nbsp;</span><span class='gantt_time'></span><div class='gantt_cancel_btn'></div></div><div class='gantt_cal_larea'></div>",
