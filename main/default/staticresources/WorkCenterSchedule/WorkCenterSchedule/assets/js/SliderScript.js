...
(function (factory) {
    ...
    function removeClass ( el, className ) {
        if ( el.classList ) {
            ...
            try{ 
                if(el.className != undefined) el.className = el.className.replace(new RegExp('(^|\\b)' + className.split(' ').join('|') + '(\\b|$)', 'gi'), ' '); 
            } catch(e){ console.log('removeClass slider e=>'+e); } 
        }
    }
...
// Interface
    ...
    function testOptions ( options ) {
        ...
        var tests = {
            ...
            'tooltips': { r: true, t: testTooltips },
    ...
    function closure ( target, options, originalOptions ){
        ...
        function tooltips ( ) {
            ...
            bindEvent('update', function(values, handleNumber, unencoded) {
                ...
                tips[handleNumber].innerHTML = '<span name="STName">' + formattedValue + '</span>';
				//tips[handleNumber].innerHTML = '<span>' + '<i name="STName">'+formattedValue+'<i>' + '</span>';
            }); // id="seletedTimeId" class="STClass"
        }
        ...
        function eventEnd ( event, data ) {
			scope_ActiveHandle = true;
            
            // The handle is no longer active, so remove the class.
            if ( scope_ActiveHandle ) {
                removeClass(scope_ActiveHandle, options.cssClasses.active); //removeClass
                scope_ActiveHandle = true;//false;
            }
            ...
            removeClass(scope_Target, options.cssClasses.drag); //removeClass
